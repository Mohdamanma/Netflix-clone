                        ...
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form onSubmit={handleSubmit} class="space-y-4 md:space-y-6" action="#">
                                <div class="space-y-4 md:space-y-6">
                                    ...
                                    <button
                                        className="w-full text-white bg-primary-600 border-2 border-white  hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-full text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 "
                                    >
                                        Signup
                                    </button>
                                </div>
